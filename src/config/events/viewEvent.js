 ...
 * for jobs processed in the `View-Queue-Events` queue.
 *
 ...
 * @description
 * A BullMQ `QueueEvents` instance configured to listen for events emitted by the "view" queue.
 ...
 *
 * @example
 * import { viewQueueEvents } from "./events/viewEvents.js";
 *
 ...
 * The queue name `"View-Queue-Events"` should match the related worker and queue setup for consistent event handling.
 */
